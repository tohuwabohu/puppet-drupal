...
The only change in this release is the update from the unmaintained `camptocamp/archive` to `puppet/archive`. No change
was needed to the classes or defines themselves.
